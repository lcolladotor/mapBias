...
library('polyester')
library('usefulstuff')
setwd(file.path(mainDir, tophat))
```
...
```{r 'countmat', results = 'asis', dev = 'CairoPNG'}
...
names(bams) <- samples
geneList <- gffReadGR(file.path('..' ,'..', 'select_genes',
    'twenty_genes.gtf'), splitByTranscript = TRUE, identifier = 'gene_name')
...
## Explore the mat
knitr::kable(countmat, format = 'html')
```

...
```{r 'scatterPlotBySample1', dev = 'CairoPNG'}
scatterBySamp(1)
```

## Sample 2

```{r 'scatterPlotBySample2', dev = 'CairoPNG'}
scatterBySamp(2)
```

## Sample 3

```{r 'scatterPlotBySample3', dev = 'CairoPNG'}
scatterBySamp(3)
```

## Sample 4

```{r 'scatterPlotBySample4', dev = 'CairoPNG'}
scatterBySamp(4)
```

## Sample 5

```{r 'scatterPlotBySample5', dev = 'CairoPNG'}
scatterBySamp(5)
```

## Sample 6

```{r 'scatterPlotBySample6', dev = 'CairoPNG'}
scatterBySamp(6)
```

## Sample 7

```{r 'scatterPlotBySample7', dev = 'CairoPNG'}
scatterBySamp(7)
```
